...
public class LoginInterceptorTest {
    ...
    @Test
    public void preHandleRedirectsUnauthenticatedRequestsToLoginPage() throws Exception {
    ...
    @Test
    public void preHandleAllowsRequestsWhenLoginExistsInSession() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest();
        MockHttpServletResponse response = new MockHttpServletResponse();
