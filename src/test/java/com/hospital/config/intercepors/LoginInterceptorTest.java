...
public class LoginInterceptorTest {
    ...
    @Test
    public void preHandleRedirectsAnonymousRequestsToLoginPage() throws Exception {
    ...
    @Test
    public void preHandleAllowsRequestsWithAuthenticatedSession() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest();
