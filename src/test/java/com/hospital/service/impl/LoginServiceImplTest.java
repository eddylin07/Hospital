...
public class LoginServiceImplTest {
    ...
    @Test
    public void publicRegistrationCannotCreateAdminWithBlankCertificate() {
    ...
    @Test
    public void duplicateUsernameIsRejectedBeforeBindingMedicalIdentity() {
        LoginServiceImpl service = new LoginServiceImpl();
        FakeLoginMapper loginMapper = new FakeLoginMapper();
        loginMapper.foundByUsername = new Login();
        FakeDoctorMapper doctorMapper = new FakeDoctorMapper();
        doctorMapper.doctorByCertId = new Doctor();
        service.loginMapper = loginMapper;
