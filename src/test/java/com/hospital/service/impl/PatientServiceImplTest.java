...
public class PatientServiceImplTest {
    ...
    @Test
    public void seekRejectsAnyUnavailableDrugBeforeWritingInventoryOrPrescription() {
        Patient patient = patient(7, "1@2,2@6");
        when(drugsMapper.selectByPrimaryKey(1)).thenReturn(drug(1, "3.50", 5));
        when(drugsMapper.selectByPrimaryKey(2)).thenReturn(drug(2, "10.00", 5));
    ...
    @Test
    public void seekRejectsNonPositiveQuantityWithoutDatabaseWrites() {
