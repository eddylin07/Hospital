...
public class PatientServiceImplTest {
    ...
    public void rejectsDispensingMoreThanAvailableStockBeforeWriting() {
        PatientServiceImpl service = serviceWithDrug(5, 1, 1);
    ...
    public void validDispenseUpdatesInventoryAndLatestSeek() {
        ...
        assertEquals(new BigDecimal("3.0"), seekMapper.updatedSeek.getPrice());
    }

    private PatientServiceImpl serviceWithDrug(Integer stock, int patientUpdateRows, int seekUpdateRows) {
        PatientServiceImpl service = new PatientServiceImpl();
        service.drugsMapper = new StubDrugsMapper(stock);
    ...
    private static class StubDrugsMapper implements DrugsMapper {
        ...
        private StubDrugsMapper(Integer stock) {
            this.stock = stock;
        }
        ...
        public Drugs selectByPrimaryKey(Integer id) {
            ...
            drugs.setPrice(new BigDecimal("1.0"));
            return drugs;
        }
