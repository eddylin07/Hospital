...
public class LoginControllerTest {
    ...
    @Test
    public void loginStoresOnlySuccessfulLoginInSession() {
        LoginController controller=new LoginController();
        controller.loginService=new LoginSuccessService();
        Login login=new Login();
        MockHttpSession session=new MockHttpSession();
    ...
    private static class LoginSuccessService extends StubLoginService {
        private LoginSuccessService() {
            super("登录成功1");
        }
