...
public class PatientControllerTest {
    ...
    public void appointmentUsesSessionPatientInsteadOfRequestBodyPatientId() {
        ...
        assertEquals(Integer.valueOf(42), appointmentService.insertedAppointment.getPatientid());
        assertEquals(Integer.valueOf(42), patientService.updatedAppointmentPatient.getId());
        assertEquals(Integer.valueOf(123), patientService.updatedAppointmentPatient.getAppointmentid());
    }
