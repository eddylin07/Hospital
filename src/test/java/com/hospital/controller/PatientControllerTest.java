...
public class PatientControllerTest {
    @Test
    public void appointmentIgnoresPatientIdFromRequestBody() {
        ...
        session.setAttribute("login", login(10, 3));
        ...
        assertEquals(Integer.valueOf(1), patientService.updatedAppointmentPointer.getId());
        assertEquals(Integer.valueOf(44), patientService.updatedAppointmentPointer.getAppointmentid());
    }
    ...
    private static class FakePatientService implements PatientService {
        private Patient updatedAppointmentPointer;
        ...
        public String updateAppointMent(Patient patient) {
            updatedAppointmentPointer = patient;
