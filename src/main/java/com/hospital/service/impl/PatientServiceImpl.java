...
public class PatientServiceImpl implements PatientService {
    ...
    public String seek(Patient patient) {
        ...
        for(String drug:drugsids.split(",")){
          ...
          dispenseItems.add(new DispenseItem(drugId,drugnumber));
          price=price.add(drugs.getPrice().multiply(BigDecimal.valueOf(drugnumber)));
        }
        for(DispenseItem dispenseItem:dispenseItems){
            Drugs drugs=new Drugs();
            drugs.setId(dispenseItem.drugId);
            drugs.setNumber(dispenseItem.quantity);
    ...
    private static class DispenseItem {
        ...
        private DispenseItem(Integer drugId, Integer quantity) {
            this.drugId = drugId;
