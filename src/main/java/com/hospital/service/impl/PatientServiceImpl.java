...
public class PatientServiceImpl implements PatientService {
    ...
    public Patient getPatient(Integer id) {
        ...
        Login login = patient.getLoginid()==null?null:loginMapper.selectByPrimaryKey(patient.getLoginid());
        if (login != null) {
    ...
    public String seek(Patient patient) {
        ...
        if(patient.getId()==null||seekMapper.getSeekByPatientId(patient.getId())==null){
            return "未找到就诊信息";
        }
