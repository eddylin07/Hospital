...
public class PatientServiceImpl implements PatientService {
    ...
    public String seek(Patient patient) {
        if (patient == null || patient.getId() == null || patient.getDrugsids() == null || patient.getDrugsids().trim().isEmpty()) {
        ...
        for(String drug:drugsids.split(",")){
            ...
            if(drugs == null || drugs.getNumber() == null || drugs.getPrice() == null || drugs.getNumber() < drugnumber){
                return "对不起药品数量不足";
            }
