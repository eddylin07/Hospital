...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        Integer requiredRole=requiredRole(request);
        if(requiredRole!=null&&!requiredRole.equals(login.getRole())){
    ...
    private Integer requiredRole(HttpServletRequest request){
        ...
        if(path.equals("/hospital/doctor/index")
                ||path.equals("/doctor/seekMedicalAdvice")
