...
public class PatientController {
    ...
    public JSONObject appointment(@RequestBody Appointment appointment,HttpSession session){
        ...
        if(CommonService.add_message_success.equals(message)){
            patient.setAppointmentid(appointment.getId()!=null?appointment.getId():appointmentService.selectTheLastAppointment(sessionPatient.getId()));
    ...
    public JSONObject downloadpdf(HttpSession session){
        ...
        if(idlast==null||appointment==null){
            json.put("message","暂无挂号单");
        }
        else{
