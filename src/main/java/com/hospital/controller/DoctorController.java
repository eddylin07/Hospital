...
public class DoctorController {
    ...
    public JSONObject printseek(@PathVariable Integer id,HttpSession session){
        ...
        Doctor doctor=doctorService.getDoctorByLoginId(login.getId());
        JSONObject json=new JSONObject();
        if(doctor==null||!canDoctorAccessPatient(doctor.getId(),id)){
            json.put("message","无权限");
            return json;
        }
    ...
    private boolean canAccessPatient(HttpSession session,Integer patientid){
        ...
        Doctor doctor=doctorService.getDoctorByLoginId(login.getId());
        return doctor!=null&&canDoctorAccessPatient(doctor.getId(),patientid);
    }

    private boolean canDoctorAccessPatient(Integer doctorid,Integer patientid){
