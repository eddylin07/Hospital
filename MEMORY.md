...
- On 2026-08-27, also fixed failed-login session persistence, role authorization, public admin self-registration, duplicate username registration binding, patient appointment IDOR, doctor workflow patient authorization, empty drug/option input crashes, and missing appointment/seek PDF crashes. `mvn test` passed with 25 tests.
