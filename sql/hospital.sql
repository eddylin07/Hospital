...
CREATE TABLE `patient`  (
  ...
  `drugsids` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '药品信息',
...
CREATE TABLE `seek`  (
  ...
  `drugs` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
